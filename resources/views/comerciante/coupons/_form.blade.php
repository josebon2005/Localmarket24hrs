...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        <label for="minimum_total" class="block text-sm font-medium text-gray-700 mb-1">Compra mínima en tu comercio</label>
    ...
    <div class="md:col-span-2">
        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Descripción para el comprador</label>
...
<div class="flex justify-end gap-3 mt-6">
    <a href="{{ route('comerciante.coupons.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
        Cancelar
    </a>
