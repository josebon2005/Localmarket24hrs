...
<head>
    ...
    <title>Nuevo cupón - LocalMarket 24hrs</title>
...
<section class="bg-gradient-to-br from-slate-900 via-slate-800 to-gray-900 text-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <h1 class="text-3xl sm:text-4xl font-black leading-tight">
            Nuevo <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400">cupón</span>
        </h1>
        <p class="text-slate-400 mt-2 text-sm">Este descuento aplicará solo a los productos de tu comercio.</p>
    </div>
