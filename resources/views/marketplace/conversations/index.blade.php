...
<header class="bg-white shadow-sm border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Mis chats</h1>
            <p class="text-sm text-gray-500">Conversaciones con comercios locales</p>
        </div>
    ...
    <section class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <a href="{{ route('marketplace.conversations.show', $conversation) }}"
               class="block px-6 py-4 border-b border-gray-100 hover:bg-gray-50">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <h2 class="font-bold text-slate-900">{{ $conversation->commerce->name }}</h2>
        ...
        @empty
            <div class="p-10 text-center">
                <h2 class="text-xl font-bold text-slate-900">Todavia no tienes chats</h2>
                <p class="text-gray-500 mt-2">Entra a un comercio y usa el boton Contactar comercio.</p>
            </div>
        @endforelse
